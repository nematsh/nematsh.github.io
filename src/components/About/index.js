    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p id = 'ps'>
            I'm student studying Computer Science 
          ...
          <p align="LEFT" id = 'ps'>
            I'm always open to meeting new people, taking on new projects
            and improving my technical skills!
          </p>
          <p id = 'ps'>
            I've completed a variety of projects that demonstrate
            my understanding of programming principles and this website/portfolio
